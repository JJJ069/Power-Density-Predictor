...
with st.sidebar:
    ...
    # 模型上传
    uploaded_model = st.file_uploader("Upload the trained model file",
                                      type=['pkl'],
                                      help="Upload the trained .pkl model file")

    # 标准化器上传
    uploaded_scaler = st.file_uploader("Upload the data scaler",
                                       type=['pkl'],
                                       help="Upload the corresponding scaler.pkl file")
